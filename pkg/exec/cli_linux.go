...
import (
	...
	"github.com/afilatov/pyroscope/pkg/util/caps"
...
func hasSysPtraceCap() bool {
	c, err := caps.Get()
	if err != nil {
		logrus.Warn("Could not read capabilities. Please submit an issue at https://github.com/afilatov/pyroscope/issues")
